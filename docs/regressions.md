...
That is the entire content. Do not include structured reusable check items in MVP 1 entries — those belong in `knowledge/jmix/` modules if they are non-obvious reminders, or in [mvp2-regression-seeds.md](../spec/mvp2-regression-seeds.md) if they are early drafts of MVP 2 scope.
...
- Reconstructed full QA scope for the area. That is MVP 2 material — record it in [mvp2-regression-seeds.md](../spec/mvp2-regression-seeds.md).
...
The MVP 2 format is intentionally not designed yet. It will be decided once at least three or four areas have accumulated enough seed material in [mvp2-regression-seeds.md](../spec/mvp2-regression-seeds.md) to make the right structure obvious.
...
3. If a draft of the full QA scope emerges, append it to [mvp2-regression-seeds.md](../spec/mvp2-regression-seeds.md) under a clear heading.
